...
<div id="footerfirst">
        ...
        <div id="footer" class="fliessfooter">
            <div class="footer_left"> © Bigpoint - All rights reserved
            </div>
            <br class="clearMe">
          </div>
    </div>
...
<div id="infofirst">
    <div id="div_infos" style="visibility:hidden;">
        <div id="infos" class="fliess10px-white"><strong></strong>DarkOrbit - MMO Space Game.<br>Be a Space Pilot in the online MMO spaceship game, DarkOrbit: a free-to-play real-time multiplayer space shooter browser game. Play with thousands of real players fighting to end the DarkOrbit space war.
Choose one of three companies, join a clan and earn power and resources in this online space game. Fight side by side with your allies and work together to win space battles and win the DarkOrbit war. But even flying solo, you'll never be bored, thanks to an astonishing variety of challenging missions!
Join the Earth, Mars or Venus company
Choose from 10 different spaceships
Compete in dangerous galactic battles either alone or in an alliance
Collect precious raw materials
Select from a large arsenal of weapons and equipment
Hunt down enemies through space
Set course to begin Free-to-Play DarkOrbit space battles now in your browser with no downloads required.<br> <br> </div>
    </div>
</div>
<!-- Infoblock -->

<div id="teaserfirst" class="fliesstext"><div id="teasertext">DARKORBIT – the free browser based action shooter<br><br><ul><li>Play now and compete against thousands of real players.</li><li>DarkOrbit is a space game full of action and fun</li><li>Browser games: No download, no installation necessary</li></ul></div></div>
...
<div id="loginForm_default_container">
    <form id="loginForm_default" method="POST" action="doLogin.php" name="loginForm_default">
        <div id="loginForm_default_link_forgot_password_container">
            <a id="loginForm_default_link_forgot" href="externalPassword.php">Password forgotten?</a>
        </div>
        ...
        <div id="loginForm_default_loginButton_container">
            <input value="Login" id="loginForm_default_loginButton" class="loginForm_default_button" name="loginForm_default_login_submit" type="submit">
        </div>
        <div id="loginForm_default_signupButton_container">
            <input value="Register" id="loginForm_default_signupButton" class="loginForm_default_button" name="loginForm_default_signup_submit" onClick="window.location='externalSignup.php'; return false;" type="submit">
        </div>
      </form>
...
<div style="position:absolute;left:448px;top:161px;"><img src="index_files/bg_claim.png" alt="" width="381"></div>
    ...
    <!-- Info-Bar -->
    <div id="infobar">
        <div id="online" class="fliesstext">Now online: <?php include("usuariosonline.php"); ?></div>
        <div id="register" class="fliesstext">Registered: <?php echo $totalRows_Cuentas ?> </div>
		<div id="register" class="fliesstext">Server status: <img src='do_img/global/intro/<?php echo $online; ?>.png' alt='<?php echo $online; ?>'  title="<?php echo $online; ?>" border='0'><b><?php echo $online_txt; ?></b></div>
        <br class="clearMe">
    </div>
    <!-- Info-Bar -->
        ...
        <div id="div_login" class="fliesstext">
            ...
            <div id="langbar" onMouseOver="showLang();" onMouseOut="hideLang();" style="z-index:1;">
                <div id="but_lang" class="fliesstext" onMouseOver="changePic('but_lang','http://localhost/do_es/do_img/global/intro/but_lang_1.png');" onMouseOut="changePic('but_lang','http://localhost/do_es/do_img/global/intro/but_lang_0.png')" style="display:block;">
                    <div style="float:left;width:167px;margin-left:10px;line-height:21px;"><a href="#">Language: </a></div>
                    <div style="float:left;margin-top:-3px;"><img src="index_files/us.png"></div>
					
                    <br class="clearMe">
                </div>
                <div id="choose_lang" style="display:none;z-index:10" onMouseOut="hideLang();">
                                               <div class="select_lang" style="background-image:url(http://localhost/do_es/do_img/global/flaggen/us.png);"><a href="index.php?lang=us" onFocus="this.blur()" style="display: block;">English US</a></div>
											   <div class="select_lang" style="background-image:url(http://localhost/do_es/do_img/global/flaggen/fr.png);"><a href="index.php?lang=fr" onFocus="this.blur()" style="display: block;">Français</a></div>
              </div>
            </div>
    ...
    <div id="right">
        ...
        <div id="teaser_nav_top" class="fliesstext">
            <div id="but_trailer" class="mm_box_std"><a href="javascript:void(0);" onFocus="this.blur()" onClick="show_preview('div_flashtrailer','but_trailer');">Trailer</a></div>
            <div id="but_ingame" class="mm_box_std"><a href="javascript:void(0);" onFocus="this.blur()" onClick="show_preview('div_ingame','but_ingame');">In-game Video</a></div>
            <div id="but_gewinne" class="mm_box_active"><a href="javascript:void(0);" onFocus="this.blur()" onClick="show_preview('div_gewinne','but_gewinne');">Winnings</a></div>
            <br class="clearMe">
        </div>
        <div id="box">
            ...
            <div id="div_gewinne" style="visibility: visible; background-image: url(&quot;http://localhost/do_es/do_img/global/intro/prizes_1.png&quot;);">
                                <div id="prizes" class="fliess10px-white">Opportunity to earn:<br>Once a month you have the chance to earn 10.000 euro</div>
          </div>
      </div>
